...
namespace PebbleSharp.Core
{
    ...
    public struct ApplicationMetadata
    {
		...
		*/
        ...
        [PebbleSerializable(Order = 6)]
        public byte AppMinorVersion { get; set; }
        [PebbleSerializable(Order = 7)]
        public ushort Size { get; set; }
        [PebbleSerializable(Order = 8)]
        public uint Offset { get; set; }
        [PebbleSerializable(Order = 9)]
        public uint CRC { get; set; }
        [PebbleSerializable(Order = 10, Size = 32)]
        public string AppName { get; set; }
        [PebbleSerializable(Order = 11, Size = 32)]
        public string CompanyName { get; set; }
        [PebbleSerializable(Order = 12)]
        public uint IconResourceID { get; set; }
        [PebbleSerializable(Order = 13)]
        public uint SymbolTableAddress { get; set; }
        [PebbleSerializable(Order = 14)]
        public uint Flags { get; set; }
        //[Serializable(Order = 15)]
        //public uint RelocationListStart { get; set; }
        [PebbleSerializable(Order = 15)]
        public uint RelocationListItemCount { get; set; }
        [PebbleSerializable(Order = 16)]
